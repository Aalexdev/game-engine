...
namespace engine::OpenGL{
	class ENGINE_API Shader : public engine::Shader{
		public:
			...
			Shader(Renderer *renderer, const std::string &name, std::filesystem::path filepath);
            Shader(Renderer *renderer, std::filesystem::path filepath);
            ~Shader();
